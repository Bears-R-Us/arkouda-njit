...
def graph_file_preprocessing(Ne: int, Nv: int, Ncol: int, directed: int, filename: str,skipline:int=0,\
                    RemapFlag:int=1, DegreeSortFlag:int=0, RCMFlag:int=0, WriteFlag:int=1, AlignedArray:int=0) -> None:
    """
    ...
    args = "{} {} {} {} {} {} {} {} {} {} {}".format(Ne, Nv, Ncol, directed, filename,skipline, \
            RemapFlag, DegreeSortFlag, RCMFlag, WriteFlag,AlignedArray)
    # currently we will not handle the AlignedArray flag except in the read procedure
    repMsg = generic_msg(cmd=cmd, args=args)
    return 
...
def graph_file_read(Ne: int, Nv: int, Ncol: int, directed: int, filename: str,\
                    RemapFlag:int=1, DegreeSortFlag:int=0, RCMFlag:int=0, WriteFlag:int=0, AlignedArray:int=0) -> Graph:
    """
