...
iteration_numbers = data.iloc[:, [1,4,9]]
print(iteration_numbers)
execution_values = data.iloc[:, [10,13,18]]
...
plt.savefig(filename+"-Speedup40UPS.png")
plt.show()
plt.close()
