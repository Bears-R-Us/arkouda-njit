...
setup(
    ...
    name='arachne_development',  # Required
    ...
    description='Client code for arachne_development',  # Optional
    ...
    keywords='HPC workflow exploratory analysis parallel distribute arrays Chapel graph',  # Optional
