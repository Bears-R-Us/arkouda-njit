...
def time_ak_process_graph():
    ...
    Test1=[ \
            [396160,18772,2,0,HomeDir+"Adata/SNAP/ca-AstroPh.txt"],\
            [3387388,403394,2,0,HomeDir+"Adata/SNAP/amazon0601.txt"],\
            [106762,26475,3,0,HomeDir+"Adata/SNAP/as-caida20071105.txt"],\
            [186936,23133,2,0,HomeDir+"Adata/SNAP/ca-CondMat.txt"],\
            [28980,5242,2,0,HomeDir+"Adata/SNAP/ca-GrQc.txt"],\
            [237010,12008,2,0,HomeDir+"Adata/SNAP/ca-HepPh.txt"],\
            [51971,9877,2,0,HomeDir+"Adata/SNAP/ca-HepTh.txt"],\
            [2987624,1134890,2,0,HomeDir+"Adata/SNAP/com-youtube.ungraph.txt"]\
             ]
