...
def time_ak_truss_graph():
    ...
    Test1=[ \
            [3387388,4033394,2,0,"/home/z/zd4/Adata/SNAP/amazon0601.txt.gr"],\
            [106762,26475,2,3,"/home/z/zd4/Adata/SNAP/as-caida20071105.txt.gr"],\
            [396160,18772,2,0,"/home/z/zd4/Adata/SNAP/ca-AstroPh.txt.gr"],\
            [186933,2,0,"/home/z/zd4/Adata/SNAP/ca-CondMat.txt.gr"],\
            [28980,5242,2,0,"/home/z/zd4/Adata/SNAP/ca-GrQc.txt.gr"],\
            [237010,12008,2,0,"/home/z/zd4/Adata/SNAP/ca-HepPh.txt.gr"],\
            [51971,9877,2,0,"/home/z/zd4/Adata/SNAP/ca-HepTh.txt.gr"],\
            [2987624,1134890,2,0,"/home/z/zd4/Adata/SNAP/com-youtube.ungraph.txt.gr"]\
             ]
    ...
    for i in TestMtx:
        ...
        Graph=njit.graph_file_read_mtx(Edges,Vertices,Columns,Directed,str(FileName),0,0)
        k=4
    ...
    for i in Test1:
        ...
        FileName=i[4]
        print(Edges,",",Vertices,",",Columns,",",Directed,",",str(FileName))
        Graph=njit.graph_file_read(Edges,Vertices,Columns,Directed,str(FileName),0,0)
        k=4
        truss=njit.graph_ktruss(Graph,k)
        print("After k=",k)
        truss=njit.graph_ktruss(Graph,-1)
