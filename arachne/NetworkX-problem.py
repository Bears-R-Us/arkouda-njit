...
#                                                                                  "Y1","Y1", "Y1", "Y1"])})
    ...
    G.add_edges_from([ (0, 1), (1, 2), (2, 0), (1, 3), (3,2)])
    node_labels = {0: 'A', 1: 'B', 2: 'C', 3: 'D'}
    nx.set_node_attributes(G, node_labels, 'label')
    edge_labels = {(0, 1): 'E1', (1, 2): 'E2', (2, 0): 'E3', (1, 3): 'E4', (3, 2): 'E5'}

    #H.add_nodes_from(range(0, 4))
    H.add_edges_from([(0, 1), (1, 2), (2, 0), (1, 3)])
    #H.add_edges_from([(3, 1), (1, 2), (2, 3), (1, 0)])
    node_labels = {0: 'A', 1: 'B', 2: 'C', 3: 'D'}
    nx.set_node_attributes(H, node_labels, 'label')
    nx.set_node_attributes(H, node_labels, 'label')
    edge_labels = {(0, 1): 'E1', (1, 2): 'E2', (2, 0): 'E3', (1, 3): 'E4'}
    """
    ...
    all_isomorphisms = nx.algorithms.isomorphism.vf2pp_all_isomorphisms(G, H)
    num = 0
    print("VF2PP found:")
    ...
    print("VF2 found ISOs:", len(subgraph_isomorphisms))
   ...
   #////////////////////////////////////////////////////////// 
    ...
    vertex_labelsG = ["A", "B", "C", "D"]
    edge_relationshipsG = ["E1","E2", "E3","E4","E5"]
    ...
    vertex_labelsH = ['A', 'B', 'C', 'D']
    edge_relationshipsH = ['E1','E2', 'E3','E4']
