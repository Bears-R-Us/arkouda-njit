...
class AlgorithmTest(ArkoudaTest):    
    def build_undirected_graph(self):
        """Builds undirected graphs in both Arachne and NetworkX for tests."""
        src_list = [2,5,2,3,3,3,2,3,5,5,5,7,8,8,9 ,10,10,24,25,25]
        dst_list = [1,0,0,0,3,3,3,4,5,2,7,8,9,5,10,7 ,7 ,24,26,27]
        ...
        return ar_graph,nx_graph

    def build_directed_graph(self):
        """Builds directed graphs in both Arachne and NetworkX for tests."""
        src_list = [2,5,2,3,3,3,2,3,5,5,5,7,8,8,9 ,10,10,24,25,25]
        dst_list = [1,0,0,0,3,3,3,4,5,2,7,8,9,5,10,7 ,7 ,24,26,27]
        src = ak.array(src_list)
        dst = ak.array(dst_list)
    ...
    def test_undirected_bfs_layers(self):
        ...
        ar_graph, nx_graph = self.build_undirected_graph()
    ...
    def test_directed_bfs_layers(self):
        """Tests Arachne bfs_layers() and compares against NetworkX."""
        # Read in graphs with Arachne and NetworkX.
        ar_graph, nx_graph = self.build_directed_graph()
