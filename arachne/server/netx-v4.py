...
def recursive_min_cut(cluster_id, subgraph, G, depth=0):
    ...
    # Check if cluster is well connected based on standard min-cut
    if mincut_value_std >= math.log10(final_nodes):
        print(f"{indent}Cluster is well connected.")
        return
...
# Optional: Function to test a triangle with a tail
