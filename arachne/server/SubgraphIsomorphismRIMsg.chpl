module SubgraphIsomorphismRIMsg {
    // Chapel modules.
    use Reflection;
    use Time;
    ...
    */
    proc subgraphIsomorphismRIMsg(cmd: string, msgArgs: borrowed MessageArgs, st: borrowed SymTab): MsgTuple throws {
        ...
        */ 
        ...
        var isopassd = runRI(g, h, subgraph_degree, graph_degree,
    ...
    use CommandMap;
    registerFunction("subgraphIsomorphismRI", subgraphIsomorphismRIMsg, getModuleName());
} // end of module