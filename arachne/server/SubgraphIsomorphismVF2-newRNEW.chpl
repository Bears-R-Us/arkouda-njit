...
*/
        ...
        proc addToTinTout(ref state: State, u : int, v: int): State throws {
            ...
            var inNeighbors = getInNeighbors(g1.n_vertices, segGraphG1, dstNodesG1, edgeRelationshipsGraphG1, u, Orig_Relationships_Mapper_G_to_Pass);
            ...
            // Get in and out neighbors
            var inNeighborsg2 = getInNeighbors(g2.n_vertices, segGraphG2, dstNodesG2, edgeRelationshipsGraphG2, v, Orig_Relationships_Mapper_H_to_Pass);
...
*/            
        ...
        proc Rpred(state: State, n1: int, n2: int): bool throws {
            ...
            // Get predecessors
            var nPreds = getInNeighbors(g1.n_vertices, segGraphG1, dstNodesG1, edgeRelationshipsGraphG1, n1, Orig_Relationships_Mapper_G_to_Pass);
            var mPreds = getInNeighbors(g2.n_vertices, segGraphG2, dstNodesG2, edgeRelationshipsGraphG2, n2, Orig_Relationships_Mapper_H_to_Pass);
...
*/
        ...
        proc Rin(state: State, n1: int, n2: int): bool throws {
            ...
            var n1Pred = getInNeighbors(g1.n_vertices, segGraphG1, dstNodesG1, edgeRelationshipsGraphG1, n1, Orig_Relationships_Mapper_G_to_Pass);
            var n2Pred = getInNeighbors(g2.n_vertices, segGraphG2, dstNodesG2, edgeRelationshipsGraphG2, n2, Orig_Relationships_Mapper_H_to_Pass);
...
*/
        ...
        proc RinRoutRnew(state, n1, n2, g1, g2) throws{

            var n1Pred = PredecessorsG1[n1];
            var n2Pred = PredecessorsG2[n2];
            var n1Succ = SuccessorsG1[n1];
            var n2Succ = SuccessorsG2[n2];
...
/*
            if !RinRoutRnew(state, n1, n2, g1, g2){
                return false;
            }
*/
        ...
        for i in 0..13 {
            ...
            if i == 5 {
                ...
                writeln("RpredRsuccRsemantic usage = ", effectiveArr[0]);
            }              
            if i == 6 {
                writeln("Rin total time = ", TimerArrNew[i]);
                writeln("Rin usage = ", effectiveArr[1]);
            }              
            if i == 7 {
            ...
            if i == 8 {
                ...
                writeln("Rnew usage = ", effectiveArr[3]);
            }              
            if i == 11 {
