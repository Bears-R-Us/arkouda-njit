module SubgraphIsomorphismVF2Msg {
    // Chapel modules.
    use Reflection;
    use Time;
    ...
    */
    proc subgraphIsomorphismVF2Msg(cmd: string, msgArgs: borrowed MessageArgs, st: borrowed SymTab): MsgTuple throws {
    ...
    use CommandMap;
    registerFunction("subgraphIsomorphismVF2", subgraphIsomorphismVF2Msg, getModuleName());
} // end of module