...
class Graph:
    ...
    def add_edges_from(self, akarray_src:pdarray, akarray_dst:pdarray,
        ...
        gb_vertices = ak.GroupBy(ak.concatenate([akarray_src,akarray_dst]))
        ...
        src_remapped = gb_vertices_remapped[0:akarray_src.size]
        dst_remapped = gb_vertices_remapped[akarray_src.size:]
