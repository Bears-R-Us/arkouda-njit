...
@typechecked
def subgraph_isomorphism_RI(G: PropGraph, H:PropGraph, type: str = "RI") -> pdarray:
    """
    Given a graph G and a subgraph H, perform a search in G matching all possible subgraphs that
    are isomorphic to H. Current contains implementations for Ullmann and RI. 
