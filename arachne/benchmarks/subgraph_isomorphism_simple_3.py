...
if __name__ == "__main__":
    ...
    G.add_edges_from([(0, 1), (1, 2), (2, 0), (0, 3), (3, 4),(4, 0), (3, 5),(3,6),(6, 7)])
    ...
    src_prop_graph = ak.array([0, 1, 2, 0, 4, 3, 3, 3, 6])
    dst_prop_graph = ak.array([1, 2, 0, 3, 0, 4, 5, 6, 7])
    labels1_prop_graph = ak.array(["lbl1"] * 8)
    labels2_prop_graph = ak.array(["lbl2"] * 8)
    rels1_prop_graph = ak.array(["rel1"] * 9)
    rels2_prop_graph =  ak.array(["rel2"] * 9)
    ...
    node_df_h = ak.DataFrame({"nodes": ak.arange(0,8), "lbls1":labels1_prop_graph,
