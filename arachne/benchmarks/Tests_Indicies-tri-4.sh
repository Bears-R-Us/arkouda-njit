...
PYTHON_SCRIPT=subgraph_indices-tri-4.py
SERVER_PORT=5555
NUM_TRIALS=10
LOG_DIR=/scratch/users/md724/arkouda-njit/arachne/benchmarks/logs-IndiexChange-tri-4/
...
run_experiment() {
    for trial in $(seq 1 $NUM_TRIALS); do
        ...
        cd $BENCHMARKS_DIR
        python3 $PYTHON_SCRIPT $SERVER_NODE $SERVER_PORT 100000 1 1 >& ${LOG_DIR}/benchmark_trial_${trial}.txt
