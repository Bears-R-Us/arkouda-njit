...
BENCHMARKS_DIR=/scratch/users/md724/arkouda-njit/arachne/benchmarks/Experiments/SX_MathoverFlow/
SERVER_PORT=5555
NUM_TRIALS=3
LOG_DIR=/scratch/users/md724/arkouda-njit/arachne/benchmarks/Experiments/SX_MathoverFlow/
TESTNUM=12 
PYTHON_SCRIPT=sx-mathoverflow-12.py
