...
BENCHMARKS_DIR=/scratch/users/md724/arkouda-njit/arachne/benchmarks/Experiments/logs-Hemibrain-tri-1
PYTHON_SCRIPT=Hemibrain-tri-1.py
SERVER_PORT=5555
NUM_TRIALS=10
LOG_DIR=/scratch/users/md724/arkouda-njit/arachne/benchmarks/Experiments/logs-Hemibrain-tri-1
