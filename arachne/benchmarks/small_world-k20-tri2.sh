...
PYTHON_SCRIPT=small_world-k20-tri2.py
SERVER_PORT=5555
NUM_TRIALS=10
LOG_DIR=/scratch/users/md724/arkouda-njit/arachne/benchmarks/logs-SWk20-tri-2/
...
run_experiment() {
    for trial in $(seq 1 $NUM_TRIALS); do
        ...
        cd $BENCHMARKS_DIR
        python3 $PYTHON_SCRIPT $SERVER_NODE $SERVER_PORT 300000 1 1 >& ${LOG_DIR}/benchmark_trial_${trial}.txt
