...
SERVER_PORT=5555
NUM_TRIALS=301
LOG_DIR=/scratch/users/md724/arkouda-njit/arachne/benchmarks/logs-DotMotif-Paper-/7
...
run_experiment() {
    for trial in $(seq 1 $NUM_TRIALS); do
        ...
        cd $BENCHMARKS_DIR
        python3 subgraph_isomorphism_DotMotif-7.py $SERVER_NODE $SERVER_PORT 1 1 >& ${LOG_DIR}/benchmark_trial_${trial}.txt
