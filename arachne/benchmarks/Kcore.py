...
if __name__ == "__main__":
    ...
    src_prop_graph = ak.array([0, 1, 2, 2, 2, 2])
    dst_prop_graph = ak.array([1, 2, 0, 3, 4, 5])
   
    labels1_prop_graph = ak.array(["lbl1"] * 6)
    labels2_prop_graph = ak.array(["lbl2"] * 6)
    ...
    node_df_h = ak.DataFrame({"nodes": ak.arange(0,6), "lbls1":labels1_prop_graph,
    ...
    labels1_subgraph = ak.array(["lbl1"] * 4)
    labels2_subgraph = ak.array(["lbl2"]*4)
