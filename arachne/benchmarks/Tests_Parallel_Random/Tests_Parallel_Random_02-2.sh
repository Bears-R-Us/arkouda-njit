...
PYTHON_SCRIPT=Tests_Parallel_Random_02-2.py
SERVER_PORT=5555
NUM_TRIALS=5
LOG_DIR=/scratch/users/md724/arkouda-njit/arachne/benchmarks/Tests_Parallel_Random/logs-Parallel-02/
THREAD_COUNTS=(128 64 32 16)

PROBABILITIES=(0.02)
NUM_NODES=(250 500 1000 2000 4000)
