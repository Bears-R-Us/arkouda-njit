...
if __name__ == "__main__":
    ...
    src_subgraph = ak.array([0, 1, 2, 3, 4, 0, 0, 1, 3])
    dst_subgraph = ak.array([1, 2, 3, 4, 0, 2, 3, 4, 1])
    labels1_subgraph = ak.array(["lbl1", "lbl1", "lbl1", "lbl1", "lbl1"])
    #labels2_subgraph = ak.array(["lbl2", "lbl2", "lbl2", "lbl2"])
    rels1_subgraph = ak.array(["rel1", "rel1", "rel1", "rel1", "rel1", "rel1", "rel1", "rel1", "rel1"])
    ...
    print(f"Arachne found: {len(isos)/5} isos")
