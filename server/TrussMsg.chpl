...
//Begin of K-Truss Functions
      ...
      proc kTrussSeqMinSearch(kvalue:int,nei:[?D1] int, start_i:[?D2] int,src:[?D3] int, dst:[?D4] int,
                        neiR:[?D11] int, start_iR:[?D12] int,srcR:[?D13] int, dstR:[?D14] int,
                        TriCount:[?D5] atomic int, EdgeDeleted:[?D6] int ):string throws{
          ...
          outMsg="After kTrussSeqMinSearch, Given K ="+k:string;
          smLogger.debug(getModuleName(),getRoutineName(),getLineNumber(),outMsg);
          outMsg="After kTrussSeqMinSearch, Total execution time="+(timer.elapsed()):string;
          smLogger.debug(getModuleName(),getRoutineName(),getLineNumber(),outMsg);
          outMsg="After kTrussSeqMinSearch, Total number of iterations ="+N2:string;
          smLogger.debug(getModuleName(),getRoutineName(),getLineNumber(),outMsg);
          outMsg="After kTrussSeqMinSearch, The k truss has edges ="+(Ne-RemovedEdge.read()):string;
          smLogger.debug(getModuleName(),getRoutineName(),getLineNumber(),outMsg);
      ...
      }// end of proc kTrussSeqMinSearch
...
//Begin of Max K-Truss Functions
      ...
      proc MaxTrussNaiveMergePath(kvalue:int,nei:[?D1] int, start_i:[?D2] int,src:[?D3] int, dst:[?D4] int,
                ...
                if ((!AllRemoved) && (kUp>3)) {// we need to check if max k  >3
                    ...
                    outMsg="After BatchMaxTrussNaiveMergePath, Total execution time ="+(maxtimer.elapsed()):string;

                    smLogger.debug(getModuleName(),getRoutineName(),getLineNumber(),outMsg);

                    outMsg="After BatchMaxTrussNaiveMergePath, Max K="+kUp:string;
                    ...
                    if (AllRemoved==false) {
                        ...
                        outMsg="After BatchMaxTrussNaiveMergePath, Max K=3";

                        smLogger.debug(getModuleName(),getRoutineName(),getLineNumber(),outMsg);
                    } else {

                        outMsg="After BatchMaxTrussNaiveMergePath,Max K=2";
      ...
      proc MaxTrussMergePath(kvalue:int,nei:[?D1] int, start_i:[?D2] int,src:[?D3] int, dst:[?D4] int,
                ...
                if ((!AllRemoved) && (kUp>3)) {// we need to check if max k  >3
                    ...
                    outMsg="After BatchMaxTrussMergePath, Total execution time ="+(maxtimer.elapsed()):string;

                    smLogger.debug(getModuleName(),getRoutineName(),getLineNumber(),outMsg);

                    outMsg="After BatchMaxTrussMergePath, Max K="+kUp:string;
                    ...
                    if (AllRemoved==false) {
                        ...
                        outMsg="After BatchMaxTrussMergePath, Max K=3";

                        smLogger.debug(getModuleName(),getRoutineName(),getLineNumber(),outMsg);
                    } else {

                        outMsg="After BatchMaxTrussMergePath,Max K=2";
      ...
      proc MaxTrussNonMinSearch(kvalue:int,nei:[?D1] int, start_i:[?D2] int,src:[?D3] int, dst:[?D4] int,
                ...
                if ((!AllRemoved) && (kUp>3)) {// we need to check if max k  >3
                    ...
                    outMsg="After BatchMaxTrussNonMinSearch, Total execution time ="+(maxtimer.elapsed()):string;

                    smLogger.debug(getModuleName(),getRoutineName(),getLineNumber(),outMsg);

                    outMsg="After BatchMaxTrussNonMinSearch, Max K="+kUp:string;
                    ...
                    if (AllRemoved==false) {
                        ...
                        outMsg="After BatchMaxTrussNonMinSearch, Max K=3";

                        smLogger.debug(getModuleName(),getRoutineName(),getLineNumber(),outMsg);
                    } else {

                        outMsg="After BatchMaxTrussNonMinSearch,Max K=2";
      ...
      proc MaxTrussSeqMinSearch(kvalue:int,nei:[?D1] int, start_i:[?D2] int,src:[?D3] int, dst:[?D4] int,
                        neiR:[?D11] int, start_iR:[?D12] int,srcR:[?D13] int, dstR:[?D14] int,
                        TriCount:[?D5] atomic int, EdgeDeleted:[?D6] int ):string throws{
                ...
                repMsg=kTrussSeqMinSearch(kLow,
                ...
                if ((!AllRemoved) && (kUp>3)) {// we need to check if max k  >3
                    ...
                    outMsg="After BatchMaxTrussSeqMinSearch, Total execution time ="+(maxtimer.elapsed()):string;

                    smLogger.debug(getModuleName(),getRoutineName(),getLineNumber(),outMsg);

                    outMsg="After BatchMaxTrussSeqMinSearch, Max K="+kUp:string;
                    ...
                    if (AllRemoved==false) {
                        ...
                        outMsg="After BatchMaxTrussSeqMinSearch, Max K=3";

                        smLogger.debug(getModuleName(),getRoutineName(),getLineNumber(),outMsg);
                    } else {

                        outMsg="After BatchMaxTrussSeqMinSearch,Max K=2";
      ...
      }// end of proc MaxTrussSeqMinSearch
      ...
      proc MaxTrussMix(kvalue:int,nei:[?D1] int, start_i:[?D2] int,src:[?D3] int, dst:[?D4] int,
                ...
                if ((!AllRemoved) && (kUp>3)) {// we need to check if max k  >3
                    ...
                    outMsg="After BatchMaxTrussMix, Total execution time ="+(maxtimer.elapsed()):string;

                    smLogger.debug(getModuleName(),getRoutineName(),getLineNumber(),outMsg);

                    outMsg="After BatchMaxTrussMix, Max K="+kUp:string;
                    ...
                    if (AllRemoved==false) {
                        ...
                        outMsg="After BatchMaxTrussMix, Max K=3";

                        smLogger.debug(getModuleName(),getRoutineName(),getLineNumber(),outMsg);
                    } else {

                        outMsg="After BatchMaxTrussMix,Max K=2";
...
//Begin of Truss Decomposition Functions
      ...
      proc TrussDecoSeqMinSearch(kvalue:int,nei:[?D1] int, start_i:[?D2] int,src:[?D3] int, dst:[?D4] int,
                        neiR:[?D11] int, start_iR:[?D12] int,srcR:[?D13] int, dstR:[?D14] int,
                        TriCount:[?D5] atomic int, EdgeDeleted:[?D6] int ):string throws{
          ...
          outMsg="After TrussDecoSeqMinSearch, Max K="+(k-1):string;
          smLogger.debug(getModuleName(),getRoutineName(),getLineNumber(),outMsg);
          outMsg="After TrussDecoSeqMinSearch, Total execution time="+(timer.elapsed()):string;
          smLogger.debug(getModuleName(),getRoutineName(),getLineNumber(),outMsg);
          outMsg="After TrussDecoSeqMinSearch, Total number of iterations ="+N2:string;
          smLogger.debug(getModuleName(),getRoutineName(),getLineNumber(),outMsg);
          outMsg="After TrussDecoSeqMinSearch, The largest number of k truss edges ="+(Ne-largest):string;
          smLogger.debug(getModuleName(),getRoutineName(),getLineNumber(),outMsg);
      ...
      }// end of proc TrussDecoSeqMinSearch
...
//Begin of Undirected Graph 
      ...
      if (!Directed) {//for undirected graph
          ...
          if (kValue>0) {// k-truss analysis
                ...
                repMsg=kTrussSeqMinSearch(kValue,
          ...
          if (kValue==-1) {// max k-truss analysis
                ...
                repMsg=MaxTrussSeqMinSearch(kValue,
          ...
          if (kValue==-2) {
                ...
                kValue=3;
                repMsg=TrussDecoSeqMinSearch(kValue,
